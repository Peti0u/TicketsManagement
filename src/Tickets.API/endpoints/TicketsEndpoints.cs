...
{
    public static void MapTicketsEndpoints(
        this WebApplication app) {
            ...
            app.MapPost("/api/Tickets", async (CreateTicketsDto dto, ITicketsService service) =>{
            ...
            app.MapPut("/api/Tickets/{id:int}", async (int id, UpdateTicketsDto dto, ITicketsService service) =>{
